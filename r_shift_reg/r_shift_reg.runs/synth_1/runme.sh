...
HD_PWD='/home/gabor7669/Desktop/DoDS1/Design_of_Digital_Systems1_RSA/r_shift_reg/r_shift_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log r_shift_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source r_shift_reg.tcl
