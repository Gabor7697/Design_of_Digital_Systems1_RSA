...
HD_PWD='/home/gabor7669/Desktop/DoDS1/Design_of_Digital_Systems1_RSA/carry_lookahead_sub/carry_lookahead_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLS.tcl
